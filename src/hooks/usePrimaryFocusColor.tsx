export default function usePrimaryFocusColor() {
  const handlePrimaryFocusColor = (primaryFocus) => {
    const collection = {
      "Abs": "dark:bg-transparent dark:border dark:border-style dark:border-green-300 dark:text-green-300 bg-green-100 text-green-900",
      "Biceps": "dark:bg-transparent dark:border dark:border-style dark:border-green-300 dark:text-green-300 bg-green-100 text-green-900",
      ...
      "Upper Chest": "dark:bg-transparent dark:border dark:border-style dark:border-indigo-300 dark:text-indigo-300 bg-indigo-100 text-indigo-900",
