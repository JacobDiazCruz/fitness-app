export default function usePrimaryFocusColor() {
  const handlePrimaryFocusColor = (primaryFocus) => {
    const collection = {
      "Abs": "dark:bg-green-300 bg-green-100 text-green-900",
      "Biceps": "dark:bg-green-300 bg-green-100 text-green-900",
      "Core": "dark:bg-green-300 bg-green-100 text-green-900",
      "Upper Chest": "dark:bg-indigo-300 bg-indigo-100 text-indigo-900",
      "Middle Chest": "dark:bg-cyan-300 bg-cyan-100 text-cyan-900",
      "Lower Chest": "dark:bg-sky-300 bg-sky-100 text-sky-900",
      "Triceps": "dark:bg-blue-300 bg-blue-100 text-blue-900",
      "Upper Back": "dark:bg-violet-300 bg-violet-100 text-violet-900",
      "Back Lats": "dark:bg-purple-300 bg-purple-100 text-purple-900",
