...
export default function Messages() {
  return (
    <div className="messages-page">
      <h5 className="text-[22px] text-medium mb-5">
        Messages
      </h5>
      <div className="h-[100vh] flex">
        ...
        {/* Chat */}
        <div className="w-full bg-white relative p-3 border-t border-t-solid border-gray-200">
          ...
          <div className="relative w-full h-[60px]">
            <div 
              className="border-gray-200 bg-[#f6f6f6] h-[60px] overflow-auto border-solid border rounded-lg p-3"
              contentEditable
            ></div>
