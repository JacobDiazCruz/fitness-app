...
export default function AccountDetails({
  ...
  return (
    <FormContainer
      ...
      handleEdit={() => setShowEditAccountDetailsModal(true)}
    >
      <div className="form-body flex items-center gap-[40px] mt-7">
